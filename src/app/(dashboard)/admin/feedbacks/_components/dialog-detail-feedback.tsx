...
import { ScrollText, Mail, Text, Calendar, UserCheck } from 'lucide-react';
...
export function DialogDetailFeedback({
    request,
    onSuccess,
    ...
    return (
        <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
            ...
            <div className="grid gap-4 py-4">
                ...
                <div className="flex items-center gap-4">
                    <div className="w-1/4 font-medium flex items-center gap-2">
                        <Calendar className="size-4 text-primary" /> Submit Date
                    </div>
                    <div className="w-3/4">
                        {format(
